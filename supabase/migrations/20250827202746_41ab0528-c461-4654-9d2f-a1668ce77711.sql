-- CORREÇÃO DE SEGURANÇA - Parte 2 (Corrigida): Implementar hash de senhas e 2FA
...
-- 3. Criar nova função segura para credentials de funcionários (corrigida)
...
BEGIN
    ...
    -- Gerar senha aleatória de 12 caracteres usando md5 e random
    random_password := substr(md5(random()::text), 1, 12);
